...
export default function About() {
  return (
    <main className="flex flex-col items-center text-brown-350 pt-space-header">
      <div className="flex py-16 w-10/12 justify-evenly items-center">
        <img className="pt-10 w-1/2 h-[450px]" src="/masterclass.webp" alt="Descrição da imagem" />
        <div className="flex flex-col w-2/5 gap-2">
          <h1 className="text-4xl">Nossos confeiteros</h1>
          <h3 className="text-xs font-medium">SOBRE CEDRIC E SEU TIME DE CONFEITEIROS</h3>
      ...
      <div className="flex flex-col p-16 gap-2 items-center text-center bg-white">
        ...
        <p className="text-xs px-32">Com uma equipe de renomados chefs confeiteiros liderada por Cedric Grolet, garantimos oferecer uma experiência única e deliciosa. Nossa expertise nos permite criar doces e bolos personalizados para todas as ocasiões, tornando seus momentos especiais ainda mais saborosos.</p>
        <div className="flex text-xl py-5 w-5/6">
          <p className="border-r py-10 px-5 border-brown-350">Descubra a Delícia da Grolet Patisserie</p>
          <p className="border-r py-10 px-5 border-brown-350">Saboreie Nossas Delícias pela Primeira Vez</p>
          <p className="border-r py-10 px-5 border-brown-350">Uma Experiência Deliciosa para Cada Ocasião</p>
          <p className="py-10 px-5">Encante-se com os Doces dos Seus Sonhos na Grolet Patisserie</p>
        </div>
        <Link href='/process' className="py-1 px-20 text-xs transition duration-500 bg-brown-350 text-white hover:bg-brown-900 rounded-full">
