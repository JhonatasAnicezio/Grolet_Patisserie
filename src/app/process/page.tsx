...
export default function Process() {
  return (
    <main className="flex flex-col text-brown-350 items-center justify-center pt-space-header">
      ...
      <div className="flex items-center py-5 w-4/5">
        ...
        <img className="w-1/2 h-80 p-6" src="/kends-patisserie.webp" alt="Descrição da imagem" />
      </div>
      <div className="flex pt-4 pb-16 w-4/5">
      ...
      <div className="flex items-center justify-center py-10 gap-5 w-4/5">
        <div className="w-[45%] h-72 bg-cover" style={{ backgroundImage: "url('/bolo-cubo-magico.webp')" }}/>
      ...
      <div className="flex pt-4 pb-28 w-5/6">
        <div className="flex flex-col gap-4 items-center text-center border-r py-10 w-1/4 px-5 border-brown-350">
          <h2 className="flex items-center justify-center text-xl rounded-full h-10 w-10 border border-brown-350">1</h2>
