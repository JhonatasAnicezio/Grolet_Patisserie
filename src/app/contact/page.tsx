    ...
    <main className="flex flex-col items-center">
          ...
          <div>
            <div className="flex flex-col gap-2">
              ...
              <nav className="flex flex-col gap-3">
                ...
                <Link href='https://www.facebook.com/cedricgrolet' className="flex items-center py-1 gap-1 border-b border-black">
                  <BsFacebook />Cedric Grolet
                </Link>
                <Link href='https://www.instagram.com/cedricgrolet/' className="flex items-center py-1 gap-1 border-b border-black">
      ...
      <div className="flex flex-col items-center justify-center bg-cover h-banner w-full" style={{ backgroundImage: "url('/frutas.webp')" }}>
        <div className="flex flex-col gap-5 p-11 items-center text-center text-brown-color rounded-3xl w-11/12 bg-white">
          ...
          <button className="px-10 rounded-full bg-brown-color text-white">AGENDE UMA CHAMADA AGORA</button>
        </div>
      </div>
    </main>
  );
