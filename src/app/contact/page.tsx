...
export default function Contact() {
  return (
    <main className="flex flex-col items-center  pt-space-header">
      <div className="flex flex-col gap-3 py-16 items-center text-center text-brown-350 w-4/5">
      ...
      <div className="flex flex-col items-center justify-center bg-cover h-banner w-full" style={{ backgroundImage: "url('/frutas.webp')" }}>
        <div className="flex flex-col gap-5 p-11 items-center text-center text-brown-350 rounded-3xl w-11/12 bg-white">
          ...
          <button className="transition duration-500 px-10 py-0.5 rounded-full hover:bg-brown-900 bg-brown-350 text-white">AGENDE UMA CHAMADA AGORA</button>
        </div>
      </div>
    </main>
  );
